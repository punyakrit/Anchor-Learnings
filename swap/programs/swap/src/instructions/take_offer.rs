...
use anchor_spl::{
    associated_token::AssociatedToken, token_interface::{ close_account, transfer_checked, CloseAccount, TransferChecked}, token_interface::{Mint, TokenAccount, TokenInterface}
};


use crate::{transfered_tokens,Offer};
...
Result<()>{
    transfered_tokens(
        ...
        ctx.accounts.offer.token_want_amount,
